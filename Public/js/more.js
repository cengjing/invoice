...
// Load this file's selection again by visiting: http://mootools.net/more/9af84b1e51ccf99fbe2138a8ed5f6c6f 
// Or build this file again with packager using: packager build More/Date.Extras More/Number.Format More/Element.Pin More/Element.Position More/Fx.Move More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Drag More/Slider More/Sortables More/Mask More/Tips More/Spinner
/*
---
copyrights:
...
if(a.suffix==null){a.suffix="%";}a.decimals=b!=null?b:(a.decimals==null?2:a.decimals);return this.format(a);}});(function(){var a=false,b=false;var c=function(){var d=new Element("div").setStyles({position:"fixed",top:0,right:0}).inject(document.body);
...
}return(a||a===0)&&a>=0&&a<this.lists.length?b[a]:b;}});Class.Occlude=new Class({occlude:function(c,b){b=document.id(b||this.element);var a=b.retrieve(c||this.property);
