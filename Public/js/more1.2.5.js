...
// Load this file's selection again by visiting: http://mootools.net/more/e758e494210928888f7efa344342b2df 
// Or build this file again with packager using: packager build More/Date.Extras More/Element.Delegation More/Element.Pin More/Element.Position More/Fx.Move More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Drag More/Slider More/Mask More/Tips More/Spinner
/*
---
copyrights:
...
},options:d});})();(function(){var a=false,b=false;var c=function(){var d=new Element("div").setStyles({position:"fixed",top:0,right:0}).inject(document.body);
...
this.previous=c;var g=e.apply(this,arguments);this.previous=f;return g;}:e);});return b;};var Spinner=new Class({Extends:Mask,Implements:Chain,options:{"class":"spinner",containerPosition:{},content:{"class":"spinner-content"},messageContainer:{"class":"spinner-msg"},img:{"class":"spinner-img"},fxOptions:{link:"chain"}},initialize:function(c,a){this.target=document.id(c)||document.id(document.body);
